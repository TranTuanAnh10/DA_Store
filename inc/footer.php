									...
									<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 hidden-sm">
										...
										<div class="staticblock">
											...
											<ul class="flow-us-link">
												...
												<li><a href="<?php echo $result['facebook'] ?>"><i class="fa-brands fa-facebook-f"></i></a></li>
												<li><a href="<?php echo $result['twitter'] ?>"><i class="fa-brands fa-twitter"></i></a></li>
												
												<li><a href="mailto:<?php echo $result['google'] ?>"><i class="fa-brands fa-google-plus-g"></i></a></li> <?php }} ?>
											</ul>
										</div>
										<!-- STATICBLOCK END -->
									</div>
