					...
					<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12" >
						<div class="second_item primari-box" >
							...
							<ul class="address">
								...
								<li><h1 style="font-size:16px;">Số Điện Thoại : </h1><input type="text" name="sdt" size="60" value="<?php echo $result['sdt']; ?>"></li><br>
								<li>
									<input type="submit" name="save" align="center" class="add-cart-text" value="Cập nhật">
								</li>	<?php
											}
										}
										?>									
